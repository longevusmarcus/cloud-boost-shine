...
export default function FertilityGoal({ onNext, onBack }) {
  ...
  return (
    <div>
      <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-2">Your Goal</h2>
      <p className="text-xs sm:text-sm md:text-base text-muted-foreground mb-5">What brings you here today?</p>
