...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-3 py-2 bg-gray-50">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-200 p-4">
          ...
          <div className="space-y-2.5 mb-4">
            ...
            <Button
              ...
              className="w-full h-11 rounded-full bg-black text-white hover:bg-gray-800 font-semibold mb-2.5 text-sm"
            >
              Continue
            </Button>
